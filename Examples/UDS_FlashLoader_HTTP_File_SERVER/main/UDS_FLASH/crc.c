#include <stdio.h>
static const uint16_t CrcTable[256u] = {
    0x0000,
    0x365e,
    0x6cbc,
    0x5ae2,
...
**	return CRC.
************************************************************/
void CreatSoftwareCrc16(uint8_t *i_pDataBuf, const uint32_t i_dataLen, uint32_t *m_pCurCrc)
{
    uint16_t crc = 0;
    uint32_t index = 0u;
    ...
    {
        crc = (crc >> 8) ^ CrcTable[(crc ^ i_pDataBuf[index]) & 0x00ff];
    }
